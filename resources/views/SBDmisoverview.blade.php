                                ...
                                if(data){
                                    ...
                                    for(var i = 0; i < obj.length; i++){
                                        ...
                                        row += '<tr>\
                                                        ...
                                                        <td class="align-middle text-center">'+phonepe_tprice+'</td>\
                                                        ...
                                                        <td class="align-middle text-center">'+paytm_tprice+'</td>\
                                                        ...
                                                        <td class="align-middle text-center">'+magicpin_tprice+'</td>\
                                                        ...
                                                        <td class="align-middle text-center">'+nobrokerhood_tprice+'</td>\
